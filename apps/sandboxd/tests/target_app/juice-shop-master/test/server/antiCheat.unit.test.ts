...
void describe('antiCheat', () => {
  ...
  void describe('checkForSourceFileOverlap', () => {
    ...
    void it('should flag 1:1 copy-paste of docker-compose.sandboxd.yml as cheating', () => {
      const fs = require('fs')
      const path = require('path')
      const sourceFile = fs.readFileSync(path.resolve('infrastructure/docker-compose.sandboxd.yml'), 'utf8')
